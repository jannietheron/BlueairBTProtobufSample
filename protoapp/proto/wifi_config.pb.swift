...
struct Espressif_RespGetStatus {
  ...
  var failReason: Espressif_WifiConnectFailedReason {
    get {
      if case .failReason(let v)? = _storage._state {return v}
      return .authError
    }
  ...
  var connected: Espressif_WifiConnectedState {
    get {
      if case .connected(let v)? = _storage._state {return v}
  ...
  enum OneOf_State: Equatable {
    ...
    static func ==(lhs: Espressif_RespGetStatus.OneOf_State, rhs: Espressif_RespGetStatus.OneOf_State) -> Bool {
      switch (lhs, rhs) {
      case (.failReason(let l), .failReason(let r)): return l == r
...
struct Espressif_WiFiConfigPayload {
  ...
  var cmdGetStatus: Espressif_CmdGetStatus {
    get {
      if case .cmdGetStatus(let v)? = _storage._payload {return v}
  ...
  var respGetStatus: Espressif_RespGetStatus {
    get {
      if case .respGetStatus(let v)? = _storage._payload {return v}
  ...
  var cmdSetConfig: Espressif_CmdSetConfig {
    get {
      if case .cmdSetConfig(let v)? = _storage._payload {return v}
  ...
  var respSetConfig: Espressif_RespSetConfig {
    get {
      if case .respSetConfig(let v)? = _storage._payload {return v}
  ...
  var cmdApplyConfig: Espressif_CmdApplyConfig {
    get {
      if case .cmdApplyConfig(let v)? = _storage._payload {return v}
  ...
  var respApplyConfig: Espressif_RespApplyConfig {
    get {
      if case .respApplyConfig(let v)? = _storage._payload {return v}
  ...
  enum OneOf_Payload: Equatable {
    ...
    static func ==(lhs: Espressif_WiFiConfigPayload.OneOf_Payload, rhs: Espressif_WiFiConfigPayload.OneOf_Payload) -> Bool {
      switch (lhs, rhs) {
      case (.cmdGetStatus(let l), .cmdGetStatus(let r)): return l == r
      case (.respGetStatus(let l), .respGetStatus(let r)): return l == r
      case (.cmdSetConfig(let l), .cmdSetConfig(let r)): return l == r
      case (.respSetConfig(let l), .respSetConfig(let r)): return l == r
      case (.cmdApplyConfig(let l), .cmdApplyConfig(let r)): return l == r
      case (.respApplyConfig(let l), .respApplyConfig(let r)): return l == r
      default: return false
      }
    }
  #endif
...
extension Espressif_CmdSetConfig: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try decoder.decodeSingularBytesField(value: &self.passphrase)
      case 3: try decoder.decodeSingularBytesField(value: &self.bssid)
...
extension Espressif_WiFiConfigPayload: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
      ...
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 10:
          ...
          if let current = _storage._payload {
            try decoder.handleConflictingOneOf()
            if case .cmdGetStatus(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
        ...
        case 11:
          ...
          if let current = _storage._payload {
            try decoder.handleConflictingOneOf()
            if case .respGetStatus(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
        ...
        case 12:
          ...
          if let current = _storage._payload {
            try decoder.handleConflictingOneOf()
            if case .cmdSetConfig(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
        ...
        case 13:
          ...
          if let current = _storage._payload {
            try decoder.handleConflictingOneOf()
            if case .respSetConfig(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
        ...
        case 14:
          ...
          if let current = _storage._payload {
            try decoder.handleConflictingOneOf()
            if case .cmdApplyConfig(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
        ...
        case 15:
          ...
          if let current = _storage._payload {
            try decoder.handleConflictingOneOf()
            if case .respApplyConfig(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .cmdGetStatus(let v)?:
        try visitor.visitSingularMessageField(value: v, fieldNumber: 10)
      case .respGetStatus(let v)?:
        try visitor.visitSingularMessageField(value: v, fieldNumber: 11)
      case .cmdSetConfig(let v)?:
        try visitor.visitSingularMessageField(value: v, fieldNumber: 12)
      case .respSetConfig(let v)?:
        try visitor.visitSingularMessageField(value: v, fieldNumber: 13)
      case .cmdApplyConfig(let v)?:
        try visitor.visitSingularMessageField(value: v, fieldNumber: 14)
      case .respApplyConfig(let v)?:
